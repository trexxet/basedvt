...
BT_SCENARIO_TEST (test_token_csi_simple) {
	BT_ASSERT_RC (Suite ("CSI simple", cases <input_as_constref<tokenize<Mode::STRICT>>> (
		...
		make_test_token_case ("CSI CSI A",   "\e[\e[A",    Token {Token::Type::CSI, 'A'}),
	...
	BT_ASSERT_RC (Suite ("CSI simple flush (strict)", cases <input_as_constref<tokenize<Mode::STRICT, true>>> (
		...
		make_test_token_case ("CSI A CSI",   "\e[A\e[",    Token {Token::Type::CSI, 'A'})
	)).run_rc());
	BT_ASSERT_RC (Suite ("CSI simple flush (input)", cases <input_as_constref<tokenize<Mode::INPUT, true>>> (
		make_test_token_case ("CSI",         "\e[",        Token {Token::Type::ESC, '['}),
		make_test_token_case ("CSI A ESC",   "\e[A\e",     Token {Token::Type::CSI, 'A'}, Token {Token::Type::ESC}),
		make_test_token_case ("CSI A CSI",   "\e[A\e[",    Token {Token::Type::CSI, 'A'}, Token {Token::Type::ESC, '['})
	)).run_rc());
	BT_SUCCESS;
}
...
BT_SCENARIO_TEST (test_token_ss3) {
	BT_ASSERT_RC (Suite ("SS3", cases <input_as_constref<tokenize<Mode::STRICT>>> (
		...
		make_test_token_case ("SS3 SS3 P", "\eO\eOP", Token {Token::Type::SS3, 'P'})
	)).run_rc());
	BT_ASSERT_RC (Suite ("SS3 flush (strict)", cases <input_as_constref<tokenize<Mode::STRICT, true>>> (
		make_test_token_case ("SS3",       "\eO"),
		make_test_token_case ("SS3 P SS3", "\eOP\eO", Token {Token::Type::SS3, 'P'})
	)).run_rc());
	BT_ASSERT_RC (Suite ("SS3 flush (input)", cases <input_as_constref<tokenize<Mode::INPUT, true>>> (
		make_test_token_case ("SS3",       "\eO",     Token {Token::Type::ESC, 'O'}),
		make_test_token_case ("SS3 P SS3", "\eOP\eO", Token {Token::Type::SS3, 'P'}, Token {Token::Type::ESC, 'O'})
	)).run_rc());
	BT_SUCCESS;
}
